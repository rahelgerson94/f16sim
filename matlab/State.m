classdef State < handle
    ...
    methods
       ...
       function dState = getDeriv(self, FaeroInB, FpropInB, MaeroInB, MpropInB)
           ...
           qW2B = Quaternion.conjugate(Quaternion.quaternionFromEulerAngles321([0, -a, b]'));
            W = c.g*params.mass;
          ...
          dState(7:10) =Quaternion.computeDerivative(qI2B, wInB );
           ...
           dState(11:self.nStates) = Quaternion.rotateVectorByQuaternion([self.qw; self.qx; self.qy;self.qz ], ...
